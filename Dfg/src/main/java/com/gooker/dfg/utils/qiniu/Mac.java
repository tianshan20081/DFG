...
public class Mac {
     ...
     * @param data
     * @return
     * @throws com.gooker.dfg.utils.qiniu.AuthException
     */
    public String sign(byte[] data) throws com.gooker.dfg.utils.qiniu.AuthException {
        ...
        try {
            ...
            throw new com.gooker.dfg.utils.qiniu.AuthException("invalid key!", e);
        } catch (NoSuchAlgorithmException e) {
            throw new com.gooker.dfg.utils.qiniu.AuthException("no algorithm called HmacSHA1!", e);
        }
     ...
     * @throws com.gooker.dfg.utils.qiniu.AuthException
     */
    public String signWithData(byte[] data) throws com.gooker.dfg.utils.qiniu.AuthException {
        ...
        try {
            ...
            throw new com.gooker.dfg.utils.qiniu.AuthException("Fail to sign with data!", e);
        }
    }
     ...
     */
    public String signRequest(HttpPost post) throws com.gooker.dfg.utils.qiniu.AuthException {
        URI uri = post.getURI();
        ...
        try {
            ...
            throw new com.gooker.dfg.utils.qiniu.AuthException("You've passed an invalid secret key!", e);
        } catch (IllegalStateException e) {
            throw new com.gooker.dfg.utils.qiniu.AuthException(e);
        }
        ...
        if (entity != null) {
            ...
            if (ct != null && "application/x-www-form-urlencoded".equals(ct.getValue())) {
