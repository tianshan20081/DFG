...
import com.gooker.dfg.ui.lvs.UpDownLvUI;
 ...
 */
public class RefreshLV extends ListView implements OnScrollListener {
    ...
    private void initFooter() {
        footerView = LayoutInflater.from(getContext()).inflate(
                R.layout.ui_lvs_up_down_more_refresh_footer, null);
