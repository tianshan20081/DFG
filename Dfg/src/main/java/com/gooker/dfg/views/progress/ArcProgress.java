...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DensityUtils.sp2px(getResources(), 40);
        default_suffix_text_size = DensityUtils.sp2px(getResources(), 15);
        default_suffix_padding = DensityUtils.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = DensityUtils.sp2px(getResources(), 10);
        default_stroke_width = DensityUtils.dp2px(getResources(), 4);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        rectF.set(strokeWidth / 2f, strokeWidth / 2f, MeasureSpec.getSize(widthMeasureSpec) - strokeWidth / 2f,
