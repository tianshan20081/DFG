...
public class NumberProgressBar extends View {
    ...
    /**
     * current progress, can not exceed
     * the max progress.
     */
    ...
    /**
     * for save and restore instance of
     * progressbar.
     */
    ...
    /**
     * the width of the text that to be
     * drawn
     */
    ...
    private void calculateDrawRectF() {
        ...
        if (getProgress() == 0) {
            ...
            mReachedRectF.left = getPaddingLeft();
            mReachedRectF.top = getHeight() / 2.0f - mReachedBarHeight / 2.0f;
            mReachedRectF.right = (getWidth() - getPaddingLeft() - getPaddingRight()) / (getMax() * 1.0f) * getProgress() - mOffset
                    + getPaddingLeft();
            mReachedRectF.bottom = getHeight() / 2.0f + mReachedBarHeight / 2.0f;
