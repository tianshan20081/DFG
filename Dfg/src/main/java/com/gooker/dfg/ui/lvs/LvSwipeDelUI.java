...
import com.gooker.dfg.adapter.swipe.SwipeAdapter;
 ...
 */
public class LvSwipeDelUI extends com.gooker.dfg.ui.BaseUI {
    private com.gooker.dfg.views.swipe.SwipeListView mSwipeListView;
    ...
    protected void loadViewLayout() {
        ...
        mSwipeListView = (com.gooker.dfg.views.swipe.SwipeListView) findViewById(R.id.example_lv_list);
    ...
    private void reload() {
        mSwipeListView.setSwipeMode(com.gooker.dfg.views.swipe.SwipeListView.SWIPE_MODE_LEFT);
        mSwipeListView.setSwipeActionLeft(com.gooker.dfg.views.swipe.SwipeListView.SWIPE_ACTION_REVEAL);
    ...
    class TestBaseSwipeListViewListener extends com.gooker.dfg.views.swipe.BaseSwipeListViewListener {
