...
import com.gooker.dfg.domain.Group;
import com.gooker.dfg.domain.People;
import com.gooker.dfg.views.PinnedHeaderExpandableListView;
import com.gooker.dfg.views.StickyLayout;
...
public class ExpandLvUI extends Activity implements
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(ExpandLvUI.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        Toast.makeText(ExpandLvUI.this,
