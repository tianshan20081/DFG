...
import com.gooker.dfg.adapter.ListViewAdapter;
import com.gooker.dfg.utils.common.Toaster;


public class PagesListViewUI extends ListActivity implements OnScrollListener {

    private static final String TAG = PagesListViewUI.class.getName().toUpperCase();
    private ListViewAdapter adapter = new ListViewAdapter(PagesListViewUI.this);
