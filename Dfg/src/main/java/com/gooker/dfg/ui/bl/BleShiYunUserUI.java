...
import com.gooker.dfg.adapter.BleSyUserAdapter;
import com.gooker.dfg.application.DGApplication;
import com.gooker.dfg.domain.BleSyUser;
    ...
    protected void setListener() {
        ...
        lvBleSyUser.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent bleUserIntent = new Intent(BleShiYunUserUI.this, BleSyUserUI.class);
