...
class SimpleMultipartEntity implements HttpEntity {
    ...
    private com.gooker.dfg.utils.net.asyncthhpclient.ResponseHandlerInterface progressHandler;

    private int bytesWritten;

    private int totalSize;

    public SimpleMultipartEntity(com.gooker.dfg.utils.net.asyncthhpclient.ResponseHandlerInterface progressHandler) {
