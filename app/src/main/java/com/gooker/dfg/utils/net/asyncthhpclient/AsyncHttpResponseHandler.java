...
import com.aoeng.degu.utils.net.asyncthhpclient.ResponseHandlerInterface;
...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    static class ResponderHandler extends Handler {
        private final WeakReference<com.aoeng.degu.utils.net.asyncthhpclient.AsyncHttpResponseHandler> mResponder;

        ResponderHandler(com.aoeng.degu.utils.net.asyncthhpclient.AsyncHttpResponseHandler service) {
            mResponder = new WeakReference<com.aoeng.degu.utils.net.asyncthhpclient.AsyncHttpResponseHandler>(service);
        }

        @Override
        public void handleMessage(Message msg) {
            com.aoeng.degu.utils.net.asyncthhpclient.AsyncHttpResponseHandler service = mResponder.get();
            if (service != null) {
