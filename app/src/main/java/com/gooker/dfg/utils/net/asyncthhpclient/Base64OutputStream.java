...
import com.aoeng.degu.utils.net.asyncthhpclient.Base64;
import com.aoeng.degu.utils.net.asyncthhpclient.Base64.Coder;
import com.aoeng.degu.utils.net.asyncthhpclient.Base64DataException;
...
public class Base64OutputStream extends FilterOutputStream {
	 ...
	 *            {@link com.aoeng.degu.utils.net.asyncthhpclient.Base64}
	 */
	...
	public Base64OutputStream(OutputStream out, int flags, boolean encode) {
		...
		this.flags = flags;
		if (encode) {
			coder = new com.aoeng.degu.utils.net.asyncthhpclient.Base64.Encoder(flags, null);
		} else {
			coder = new com.aoeng.degu.utils.net.asyncthhpclient.Base64.Decoder(flags, null);
		}
	}
