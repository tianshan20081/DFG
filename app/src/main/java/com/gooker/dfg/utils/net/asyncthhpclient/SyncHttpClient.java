...
import com.aoeng.degu.utils.net.asyncthhpclient.AsyncHttpRequest;
...
public class SyncHttpClient extends AsyncHttpClient {
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client,
		...
		*/
        new com.aoeng.degu.utils.net.asyncthhpclient.AsyncHttpRequest(client, httpContext, uriRequest, responseHandler).run();
