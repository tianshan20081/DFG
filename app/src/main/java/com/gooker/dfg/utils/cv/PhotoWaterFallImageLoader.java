...
public class PhotoWaterFallImageLoader {
	...
	private static com.aoeng.degu.utils.cv.PhotoWaterFallImageLoader imageLoader;
	...
	public static com.aoeng.degu.utils.cv.PhotoWaterFallImageLoader instancePhotoWaterFallImageLoader() {
		if (imageLoader == null) {
			return new com.aoeng.degu.utils.cv.PhotoWaterFallImageLoader();
		} else {
			return imageLoader;
		}
	}
