...
public class FileUtils {
	...
	public static File getPhonePhotoFolder() {
		// TODO Auto-generated method
		// stub
		com.aoeng.degu.utils.common.LogUtils.i("Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM)+"
				+ Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getAbsoluteFile());
		com.aoeng.degu.utils.common.LogUtils.i("Environment.getDataDirectory()" + Environment.getDataDirectory().getAbsolutePath());
	...
	public static String readProperties(String filePath, String key, String defaultValue) {
		...
		try {
			...
			com.aoeng.degu.utils.common.LogUtils.e(e);
		} finally {
			IOUtils.close(fis);
		}
		return value;
	...
	private static String getDir(String name) {
		...
		if (StringUtils.isEmpty(name)) {
			com.aoeng.degu.utils.common.LogUtils.e(" folder name is null");
			return null;
		}
	...
	public static List<String> getCarshFiles() {
		...
		String path = com.aoeng.degu.utils.common.FileUtils.getAppCrashPath();
		com.aoeng.degu.utils.common.LogUtils.i("appcrashpath " + path);
		if (!StringUtils.isEmpty(path)) {
	...
	public static File getCrashFile() {
		...
		String crashPath = com.aoeng.degu.utils.common.FileUtils.getAppCrashPath();
