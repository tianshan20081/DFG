package com.gooker.dfg.utils.svgandroid;
...
import com.aoeng.degu.utils.svgandroid.*;
import com.aoeng.degu.utils.svgandroid.ParserHelper;
import com.aoeng.degu.utils.svgandroid.SVG;
...
public class SVGParser {
     ...
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromInputStream(InputStream svgData) throws SVGParseException {
        return com.aoeng.degu.utils.svgandroid.SVGParser.parse(svgData, 0, 0, false);
    }
     ...
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromInputStream(InputStream svgData, int targetWidth, int targetHeight)
            throws SVGParseException {
        return com.aoeng.degu.utils.svgandroid.SVGParser.parse(svgData, 0, 0, false, targetWidth, targetHeight);
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromResource(Resources resources, int resId) throws SVGParseException {
        return com.aoeng.degu.utils.svgandroid.SVGParser.parse(resources.openRawResource(resId), 0, 0, false);
    }
     ...
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromAsset(AssetManager assetMngr, String svgPath) throws SVGParseException, IOException {
        InputStream inputStream = assetMngr.open(svgPath);
        com.aoeng.degu.utils.svgandroid.SVG svg = getSVGFromInputStream(inputStream);
        inputStream.close();
        return svg;
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromInputStream(InputStream svgData, int searchColor, int replaceColor,
                                            int targetWidth, int targetHeight) throws SVGParseException {
        return com.aoeng.degu.utils.svgandroid.SVGParser.parse(svgData, searchColor, replaceColor, false, targetWidth, targetHeight);
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromString(String svgData, int searchColor, int replaceColor) throws SVGParseException {
        return com.aoeng.degu.utils.svgandroid.SVGParser.parse(new ByteArrayInputStream(svgData.getBytes()), searchColor, replaceColor, false);
    }
     ...
     * @throws SVGParseException if there is an error while parsing.
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromResource(Resources resources, int resId, int searchColor, int replaceColor) throws SVGParseException {
        return com.aoeng.degu.utils.svgandroid.SVGParser.parse(resources.openRawResource(resId), searchColor, replaceColor, false);
    }
     ...
     * @throws IOException       if there was a problem reading the file.
     */
    public static com.aoeng.degu.utils.svgandroid.SVG getSVGFromAsset(AssetManager assetMngr, String svgPath, int searchColor, int replaceColor) throws SVGParseException, IOException {
        InputStream inputStream = assetMngr.open(svgPath);
        com.aoeng.degu.utils.svgandroid.SVG svg = getSVGFromInputStream(inputStream, searchColor, replaceColor);
        inputStream.close();
        return svg;
    }
    ...
    private static com.aoeng.degu.utils.svgandroid.SVG parse(InputStream in, Integer searchColor, Integer replaceColor, boolean whiteMode,
                             int targetWidth, int targetHeight) throws SVGParseException {
...
//        Util.debug("Parsing complete in " + (System.currentTimeMillis() - start) + " millis.");
            com.aoeng.degu.utils.svgandroid.SVG result = new com.aoeng.degu.utils.svgandroid.SVG(picture, handler.bounds);
