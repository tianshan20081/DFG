...
import com.aoeng.degu.utils.net.asyncthhpclient.*;
import com.aoeng.degu.utils.net.asyncthhpclient.MySSLSocketFactory;
import com.aoeng.degu.utils.net.asyncthhpclient.PersistentCookieStore;
import com.aoeng.degu.utils.net.asyncthhpclient.RequestHandle;
import com.aoeng.degu.utils.net.asyncthhpclient.RetryHandler;
...
public class AsyncHttpClient {
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        httpClient.setHttpRequestRetryHandler(new com.aoeng.degu.utils.net.asyncthhpclient.RetryHandler(DEFAULT_MAX_RETRIES, DEFAULT_RETRY_SLEEP_TIME_MILLIS));
    }

    public static void allowRetryExceptionClass(Class<?> cls) {
        if (cls != null) {
            com.aoeng.degu.utils.net.asyncthhpclient.RetryHandler.addClassToWhitelist(cls);
        }
    }

    public static void blockRetryExceptionClass(Class<?> cls) {
        if (cls != null) {
            com.aoeng.degu.utils.net.asyncthhpclient.RetryHandler.addClassToBlacklist(cls);
        }
    }
    ...
    public void setMaxRetriesAndTimeout(int retries, int timeout) {
        this.httpClient.setHttpRequestRetryHandler(new com.aoeng.degu.utils.net.asyncthhpclient.RetryHandler(retries, timeout));
    }
