...
package com.gooker.dfg.views.swipe;
...
import com.aoeng.degu.views.swipe.*;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private int swipeMode = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_BOTH;
    ...
    // Fixed properties
    private com.aoeng.degu.views.swipe.SwipeListView swipeListView;
    ...
    private int swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_NONE;

    private int swipeActionLeft = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_REVEAL;
    private int swipeActionRight = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_REVEAL;
     ...
     */
    public SwipeListViewTouchListener(com.aoeng.degu.views.swipe.SwipeListView swipeListView, int swipeFrontView, int swipeBackView) {
    ...
    protected boolean isSwipeEnabled() {
        return swipeMode != com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_NONE;
    }
    ...
    private void swapChoiceState(int position) {
        ...
        if (lastCount == 0 && count == 1) {
            ...
            closeOpenedItems();
            setActionsTo(com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_CHOICE);
        }
    ...
    private void generateAnimate(final View view, final boolean swap, final boolean swapRight, final int position) {
        ...
        if (swipeCurrentAction == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_REVEAL) {
            generateRevealAnimate(view, swap, swapRight, position);
        }
        if (swipeCurrentAction == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_DISMISS) {
            generateDismissAnimate(parentView, swap, swapRight, position);
        }
        if (swipeCurrentAction == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_CHOICE) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (MotionEventCompat.getActionMasked(motionEvent)) {
            case MotionEvent.ACTION_DOWN: {
                ...
                swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_NONE;
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (!opened.get(downPosition)) {
                    if (swipeMode == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_LEFT && velocityTracker.getXVelocity() > 0) {
                        velocityX = 0;
                    }
                    if (swipeMode == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_RIGHT && velocityTracker.getXVelocity() < 0) {
                        velocityX = 0;
                    }
                }
...
//                }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (swipeMode == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_NONE) {
                    deltaMode = 0;
                } else if (swipeMode != com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_BOTH) {
                    if (opened.get(downPosition)) {
                        if (swipeMode == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_LEFT && deltaX < 0) {
                            deltaMode = 0;
                        } else if (swipeMode == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_RIGHT && deltaX > 0) {
                            deltaMode = 0;
                        }
                    } else {
                        if (swipeMode == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_MODE_LEFT && deltaX > 0) {
                ...
                if (deltaMode > slop && swipeCurrentAction == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_NONE && velocityY < velocityX) {
                    swiping = true;
                    ...
                    if (opened.get(downPosition)) {
                        ...
                        swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_REVEAL;
                    } else {
                        if (swipingRight && swipeActionRight == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_DISMISS) {
                            swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_DISMISS;
                        } else if (!swipingRight && swipeActionLeft == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_DISMISS) {
                            swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_DISMISS;
                        } else if (swipingRight && swipeActionRight == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_CHOICE) {
                            swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_CHOICE;
                        } else if (!swipingRight && swipeActionLeft == com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_CHOICE) {
                            swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_CHOICE;
                        } else {
                            swipeCurrentAction = com.aoeng.degu.views.swipe.SwipeListView.SWIPE_ACTION_REVEAL;
                        }
