...

{
	...
	private static final String TAG = com.aoeng.degu.views.ClipZoomImageView.class.getSimpleName();
		...
		mGestureDetector = new GestureDetector(context, new SimpleOnGestureListener() {
			...
			public boolean onDoubleTap(MotionEvent e) {
				...
				if (getScale() < SCALE_MID) {
					com.aoeng.degu.views.ClipZoomImageView.this.postDelayed(new AutoScaleRunnable(SCALE_MID, x, y), 16);
					isAutoScale = true;
				} else {
					com.aoeng.degu.views.ClipZoomImageView.this.postDelayed(new AutoScaleRunnable(initScale, x, y), 16);
					isAutoScale = true;
				}
	...
	private class AutoScaleRunnable implements Runnable {
		...
		public void run() {
			...
			if (((tmpScale > 1f) && (currentScale < mTargetScale)) || ((tmpScale < 1f) && (mTargetScale < currentScale))) {
				com.aoeng.degu.views.ClipZoomImageView.this.postDelayed(this, 16);
			} else
			// 设置为目标的缩放比例
			{
