...
/**
 * May 16, 2014 6:22:22 PM
 * 
 */
public abstract class BaseImageView extends ImageView {
	private static final String TAG = com.aoeng.degu.views.BaseImageView.class.getSimpleName();
	...
	protected void onDraw(Canvas canvas) {
		if (!isInEditMode()) {
			...
			try {
				...
				Log.e(TAG,
						String.format("Failed to draw, Id :: %s. Error occurred :: %s", getId(),
								e.toString()));
			} finally {
