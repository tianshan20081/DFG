 ...
 */
public class SwipeListSingleViewTouchListener implements View.OnTouchListener {
	...
	// Fixed properties
	private com.aoeng.degu.views.swipe.SwipeListSingleView swipeListView;
	 ...
	 */
	public SwipeListSingleViewTouchListener(SwipeListSingleView swipeListView, int swipeFrontView, int swipeBackView) {
	...
	protected void openAnimate(int position) {
		openAnimate(
				swipeListView.getChildAt(position - swipeListView.getFirstVisiblePosition()).findViewById(
