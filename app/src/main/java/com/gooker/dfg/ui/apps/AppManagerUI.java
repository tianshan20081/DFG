...
import com.aoeng.degu.ui.apps.*;
import com.aoeng.degu.ui.apps.AllAppUI;
...
public class AppManagerUI extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btnUploadAppsInfo:
			Intent service = new Intent(com.aoeng.degu.ui.apps.AppManagerUI.this, UploadAppsInfoService.class);
