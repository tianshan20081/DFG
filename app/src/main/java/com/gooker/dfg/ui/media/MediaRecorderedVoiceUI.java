...
import com.aoeng.degu.listener.SpeakButtonTouchListener;
import com.aoeng.degu.listener.SpeakButtonTouchListener.OnActionListener;
import com.aoeng.degu.ui.BaseUI;
import com.aoeng.degu.utils.MediaUtil;
...
public class MediaRecorderedVoiceUI extends BaseUI {
	...
	public void onClick(View v) {
		...
		case R.id.ivSpeakDel:
			dialog = new Builder(com.aoeng.degu.ui.media.MediaRecorderedVoiceUI.this);
	...
	protected void setListener() {
		...
		touchListener.setListener(new OnActionListener() {
			@Override
