...
import com.aoeng.degu.ui.media.*;
import com.aoeng.degu.ui.media.AudioPlayUI;
import com.aoeng.degu.ui.media.CameraUI;
import com.aoeng.degu.ui.media.IntentCameraUI;
import com.aoeng.degu.ui.media.IntentVideoCameraUI;
import com.aoeng.degu.ui.media.MediaRecorderedVoiceUI;
import com.aoeng.degu.ui.media.RawAudioUI;
import com.aoeng.degu.ui.media.SoundPoolUI;
import com.aoeng.degu.ui.media.VideoViewUI;
...
public class MediaHomeUI extends com.gooker.dfg.ui.BaseUI {
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.btnCamera:
			startActivity(new Intent(this, com.gooker.dfg.ui.media.CameraUI.class));
			break;
		case R.id.btnIntentCamera:
			startActivity(new Intent(this, com.gooker.dfg.ui.media.IntentCameraUI.class));
			break;
		case R.id.btnRawAudio:
			startActivity(new Intent(this, com.gooker.dfg.ui.media.RawAudioUI.class));
			break;
		...
		case R.id.btnAudioPlay:
			startActivity(new Intent(this, com.gooker.dfg.ui.media.AudioPlayUI.class));
			break;
