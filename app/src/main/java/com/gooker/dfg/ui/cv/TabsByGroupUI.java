...
import com.aoeng.degu.ui.cv.*;
import com.aoeng.degu.ui.cv.FourView;
import com.aoeng.degu.ui.cv.OneView;
import com.aoeng.degu.ui.cv.ThreeView;
...
public class TabsByGroupUI extends ActivityGroup {
	...
	public void showView(int flag) {
		...
		case 0:
			...
			View v = getLocalActivityManager().startActivity("one", new Intent(com.aoeng.degu.ui.cv.TabsByGroupUI.this, OneView.class)).getDecorView();
		...
		case 1:
			bodyView.removeAllViews();
			bodyView.addView(getLocalActivityManager().startActivity("two", new Intent(com.aoeng.degu.ui.cv.TabsByGroupUI.this, TwoView.class)).getDecorView());
		...
		case 2:
			bodyView.removeAllViews();
			bodyView.addView(getLocalActivityManager().startActivity("three", new Intent(com.aoeng.degu.ui.cv.TabsByGroupUI.this, ThreeView.class)).getDecorView());
			one.setBackgroundResource(R.drawable.frame_button_nopressbg);
			two.setBackgroundResource(R.drawable.frame_button_nopressbg);
		...
		case 3:
			bodyView.removeAllViews();
			bodyView.addView(getLocalActivityManager().startActivity("four", new Intent(com.aoeng.degu.ui.cv.TabsByGroupUI.this, FourView.class)).getDecorView());
			one.setBackgroundResource(R.drawable.frame_button_nopressbg);
			two.setBackgroundResource(R.drawable.frame_button_nopressbg);
			three.setBackgroundResource(R.drawable.frame_button_nopressbg);
