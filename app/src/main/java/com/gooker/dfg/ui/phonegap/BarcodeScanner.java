...
public class BarcodeScanner extends Plugin {
	 ...
	 * 
	 * @param types
	 *            The barcode types to accept
	 * @param installTitle
	 *            The title for the dialog box that prompts the user to install the scanner
	 * @param installMessage
	 *            The message prompting the user to install the barcode scanner
	 * @param yesString
	 *            The string "Yes" or localised equivalent
	 * @param noString
	 *            The string "No" or localised version
	 */
	 ...
	 * 
	 * @param requestCode
	 *            The request code originally supplied to startActivityForResult(), allowing you to identify who this result came from.
	 * @param resultCode
