...
import com.aoeng.degu.ui.lvs.PullToRefreshListView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		weiboListView.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				...
				new GetDataTask(com.aoeng.degu.ui.lvs.PullToRefreshUI.this, 0).execute();
			}

			@Override
			public void onLoadMore() {
				new GetDataTask(com.aoeng.degu.ui.lvs.PullToRefreshUI.this, 1).execute();
			}
		});
