...
import com.aoeng.degu.ui.imgs.MonitoredActivity;
...
public class Util {
	...
	private static class BackgroundJob extends com.aoeng.degu.ui.imgs.MonitoredActivity.LifeCycleAdapter implements Runnable {

		private final com.aoeng.degu.ui.imgs.MonitoredActivity mActivity;
		...
		public BackgroundJob(com.aoeng.degu.ui.imgs.MonitoredActivity activity, Runnable job, ProgressDialog dialog, Handler handler) {
