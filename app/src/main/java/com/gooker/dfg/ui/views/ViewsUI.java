...
import com.aoeng.degu.ui.views.NumProgressBarUI;
import com.aoeng.degu.ui.views.ProgressUI;
import com.aoeng.degu.ui.views.TableLayoutUI;
...
public class ViewsUI extends BaseUI {
	...
	public void onClick(View v) {
		...
		case R.id.btnTableLayout:
			startActivity(new Intent(com.aoeng.degu.ui.views.ViewsUI.this, TableLayoutUI.class));
			break;
