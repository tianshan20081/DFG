...
public class NLPullRefreshView extends LinearLayout {
	...
	private void init() {
		...
		// 刷新视图顶端的的view
		refreshView = LayoutInflater.from(mContext).inflate(R.layout.ui_lvs_rf_top_item, null);
		// 指示器view
	...
	/**
	 * 此方法兼容两种子布局的判断，listview，scrollview 主要作用是判断两个子View是否滚动到了最上面，若是，则表示此次touch move事件截取然后让layout来处理，来移动下拉视图，反之则不然
	 * 
	...
	public interface RefreshListener {
		public void onRefresh(com.aoeng.degu.ui.lvs.NLPullRefreshView view);
	}
