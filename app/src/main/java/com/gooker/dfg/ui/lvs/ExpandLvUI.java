...
import com.aoeng.degu.domain.People;
import com.aoeng.degu.views.PinnedHeaderExpandableListView;
import com.aoeng.degu.views.PinnedHeaderExpandableListView.OnHeaderUpdateListener;
import com.aoeng.degu.views.StickyLayout;
import com.aoeng.degu.views.StickyLayout.OnGiveUpTouchEventListener;

/**
 * May 16, 2014 4:19:53 PM PinnedHeaderExpandableListView
 */

public class ExpandLvUI extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_lvs_expand);
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(com.aoeng.degu.ui.lvs.ExpandLvUI.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        Toast.makeText(com.aoeng.degu.ui.lvs.ExpandLvUI.this,
