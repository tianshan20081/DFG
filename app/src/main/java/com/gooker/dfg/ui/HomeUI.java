...
import com.aoeng.degu.ui.*;
import com.aoeng.degu.ui.BaseUI;
import com.aoeng.degu.ui.Chapter1UI;
import com.aoeng.degu.ui.CustomerViewUI;
import com.aoeng.degu.ui.DataSaveUI;
import com.aoeng.degu.ui.FrameUI;
import com.aoeng.degu.ui.WidgetUI;
...
public class HomeUI extends BaseUI implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btnHandler:
			...
			break;
		case R.id.btnEnc:
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, EncHomeUI.class);
			break;
		...
		case R.id.btnLocations:
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, LocationsUI.class);
			break;
		case R.id.btnListViews:
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, ListViewsUI.class);
			break;
		...
		case R.id.btnSystemUI:
			...
			break;
		case R.id.chapter1:
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, Chapter1UI.class);
			break;
		case R.id.chapter2:
		...
		case R.id.btnCustomerUI:
			// 自定义控件
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, CustomerViewUI.class);
			break;
		case R.id.btnLoginUIs:
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, LoginUIs.class);
			break;
		case R.id.btnImgs:
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, ImageViewsHomeUI.class);
			break;
		case R.id.btnApp:// 应用程序管理
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, AppManagerUI.class);
			break;
		case R.id.btnSecurity:// 反编译与安全
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, SecurityUI.class);
			break;
		case R.id.btnViews://
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, ViewsUI.class);
			break;
		case R.id.btnMobileManager:// 手机管理
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, MobileManagerHomeUI.class);
			break;
		case R.id.btnBleHome:// 手机管理
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, BlHomeUI.class);
			break;
		case R.id.btnShell:// run shell command
			intent = new Intent(com.aoeng.degu.ui.HomeUI.this, ShellHomeUI.class);
			break;
		case R.id.btnAnim:
			break;
		}
