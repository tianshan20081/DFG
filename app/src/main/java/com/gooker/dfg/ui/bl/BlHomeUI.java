...
import com.aoeng.degu.ui.bl.*;
import com.aoeng.degu.ui.bl.BleShiYunHomeUI;
import com.aoeng.degu.ui.bl.BleYcHomeUI;
import com.aoeng.degu.ui.bl.MiLeHomeUI;
...
public class BlHomeUI extends BaseUI {
		...
		lvBles.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				case BleUtils.BLE_MIBIND:
					bleItemIntent = new Intent(com.aoeng.degu.ui.bl.BlHomeUI.this, MiLeHomeUI.class);
					bleItemIntent.putExtra("deviceInfo", device);
					startActivity(bleItemIntent);
					break;
				case BleUtils.BLE_SHIYUN:
					bleItemIntent = new Intent(com.aoeng.degu.ui.bl.BlHomeUI.this, BleShiYunHomeUI.class);
					bleItemIntent.putExtra("deviceInfo", device);
					startActivity(bleItemIntent);
					break;
				case BleUtils.BLE_YICHENG:
					bleItemIntent = new Intent(com.aoeng.degu.ui.bl.BlHomeUI.this, BleYcHomeUI.class);
					bleItemIntent.putExtra("deviceInfo", device);
					startActivity(bleItemIntent);
					break;
				default:
	...
	protected void processLogic() {
		// TODO Auto-generated method stub
		mBleAdapter = new BleAdapter(com.aoeng.degu.ui.bl.BlHomeUI.this, mDevices);
