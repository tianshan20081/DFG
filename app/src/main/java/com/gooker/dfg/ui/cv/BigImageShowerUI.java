...
public class BigImageShowerUI extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageLoadingDialog = new BigImageLoadingDialog(com.aoeng.degu.ui.cv.BigImageShowerUI.this);
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected void onPostExecute(Void result) {
				...
				if (null != bitmap) {
					...
					Toast.makeText(com.aoeng.degu.ui.cv.BigImageShowerUI.this, "图片下载失败", Toast.LENGTH_LONG).show();
				}
