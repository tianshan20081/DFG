...
public class BitmapManager {
    ...
    private static com.aoeng.degu.ui.imgs.BitmapManager sManager = null;
    ...
    public static synchronized com.aoeng.degu.ui.imgs.BitmapManager instance() {

        if (sManager == null) {
            sManager = new com.aoeng.degu.ui.imgs.BitmapManager();
        }
        return sManager;
    }
