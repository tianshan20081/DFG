...
import com.aoeng.degu.ui.media.MediaControlReceiver;

/**
 * Jun 9, 2014 3:53:26 PM
 * 
 */
@SuppressLint("NewApi")
public class AudioPlayUI extends Activity {

	static final String TAG = "AudioPlayUI";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ui_media_audioplayer);
	...
	private OnAudioFocusChangeListener focusChangeListener = new OnAudioFocusChangeListener() {
		...
		public void onAudioFocusChange(int focusChange) {
			...
			case (AudioManager.AUDIOFOCUS_LOSS):
				stop();
				ComponentName component = new ComponentName(com.aoeng.degu.ui.media.AudioPlayUI.this,
	...
	private void setRemoteControlMetadata(Bitmap artwork, String album, String artist,
			long trackNumber) {
		/**
