...
import com.aoeng.degu.ui.lvs.ExpandLvUI;
import com.aoeng.degu.ui.lvs.LvScrollDelUI;
import com.aoeng.degu.ui.lvs.LvSwipeDelUI;
import com.aoeng.degu.ui.lvs.LvSwipeSingleDelUI;
import com.aoeng.degu.ui.lvs.MovingDelItemLvUI;
import com.aoeng.degu.ui.lvs.NormalListViewUI;
import com.aoeng.degu.ui.lvs.PagesListViewUI;
import com.aoeng.degu.ui.lvs.PullToRefreshUI;
import com.aoeng.degu.ui.lvs.ReflashListUI;
...
public class ListViewsUI extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btnExpandLv:
			startActivity(new Intent(ListViewsUI.this, com.gooker.dfg.ui.lvs.ExpandLvUI.class));
			break;
		...
		case R.id.btnUpDownLv:
			startActivity(new Intent(ListViewsUI.this, com.gooker.dfg.ui.lvs.UpDownLvUI.class));
			break;
		}
	}
}
